...
test('greg2abs', (t) => {
  ...
  t.is(greg.greg2abs(new Date(2005, 3, 2)), 732038);
});
...
test('abs2greg', (t) => {
  t.deepEqual(ymd(greg.abs2greg(737553)), {yy: 2020, mm: 5, dd: 8});
  t.deepEqual(ymd(greg.abs2greg(689578)), {yy: 1888, mm: 12, dd: 31});
  t.deepEqual(ymd(greg.abs2greg(732038)), {yy: 2005, mm: 4, dd: 2});
});

test('abs2greg-88ce', (t) => {
  t.deepEqual(ymd(greg.abs2greg(32141)), {yy: 88, mm: 12, dd: 30});
  t.deepEqual(ymd(greg.abs2greg(32142)), {yy: 88, mm: 12, dd: 31});
  t.deepEqual(ymd(greg.abs2greg(32143)), {yy: 89, mm: 1, dd: 1});
});
...
test.skip('greg2abs-1752-reformation', (t) => {
  t.is(greg.greg2abs(new Date(1752, 8, 14)), 639797);
  // t.is(greg.greg2abs(new Date(1752, 8, 2)), 639796);
  t.is(greg.greg2abs(new Date(1752, 5, 2)), 639704);
  t.is(greg.greg2abs(new Date(1751, 0, 1)), 639186);
});
...
test.skip('abs2greg-1752-reformation', (t) => {
  t.deepEqual(ymd(greg.abs2greg(639797)), {yy: 1752, mm: 9, dd: 14});
  t.deepEqual(ymd(greg.abs2greg(639796)), {yy: 1752, mm: 9, dd: 2});
  t.deepEqual(ymd(greg.abs2greg(639186)), {yy: 1751, mm: 1, dd: 1});
});
